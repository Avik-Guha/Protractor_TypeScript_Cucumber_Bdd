...
class CommonFunctions_MT {
     ...
     **** @Creator Avik Guha
     **/
    checkValue(elementLocation, valueToCheck) {
        return __awaiter(this, void 0, void 0, function* () {
            yield protractor_1.browser.wait(EC.visibilityOf(elementLocation), 60000);
            yield expect(elementLocation.isDisplayed()).to.be.eventually.true;
            yield expect(elementLocation.getText()).to.eventually.equal(valueToCheck);
        });
    }
    /****** Get the Length
    ...
    select(elementLocation) {
        return __awaiter(this, void 0, void 0, function* () {
            yield protractor_1.browser.wait(EC.visibilityOf(elementLocation), 60000);
            /*const isSelected: boolean = expect(elementLocation.isSelected()).to.be.eventually.true;
    
            if (isSelected == true) {
                console.log("Element is already in selected state.");
            }
            else {
